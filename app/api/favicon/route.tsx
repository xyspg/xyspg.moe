...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://xyspg.moe/favicons/zolplay.png',
  '(?:github.com)': 'https://xyspg.moe/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://xyspg.moe/favicons/twitter.png',
  'coolshell.cn': 'https://xyspg.moe/favicons/coolshell.png',
  'vercel.com': 'https://xyspg.moe/favicons/vercel.png',
  'nextjs.org': 'https://xyspg.moe/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://xyspg.moe/favicon_blank.png'
