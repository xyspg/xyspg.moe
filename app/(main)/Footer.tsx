...
async function LastVisitorInfo() {
	let lastVisitor: VisitorGeolocation | undefined;
	if (env.VERCEL_ENV === "production") {
				...
				<div className="border-t border-zinc-100 pb-16 pt-10 dark:border-zinc-700/40">
					<Container.Inner>
						...
						<div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
							<p className="text-sm text-zinc-500/80 dark:text-zinc-400/80 flex flex-row gap-2">
								&copy; {new Date().getFullYear()} xyspg.&nbsp;{" "}
								<a
									href="https://icp.gov.moe/?keyword=20260721"
									target="_blank"
									rel="noopener"
								>
									萌ICP备20260721号
								</a>
								<PeekabooLink href="https://github.com/xyspg/xyspg.moe">
									GitHub
								</PeekabooLink>
							</p>
							<Links />
