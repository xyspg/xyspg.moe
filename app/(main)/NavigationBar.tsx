  ...
  return (
    <li>
      ...
      >
        ...
        {isActive && (
          <motion.span
            className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-teal-700/0 via-teal-700/70 to-teal-700/0 dark:from-teal-400/0 dark:via-teal-400/40 dark:to-teal-400/0"
  ...
  return (
    <nav
      ...
      className={clsxm(
        ...
        '[--spotlight-color:rgb(204_251_241_/_0.6)] dark:[--spotlight-color:rgb(153_246_228_/_0.07)]',
        className
      )}
      {...props}
    >
